...
// of panels that point at the element to which the panel is anchored. But in
// order to do that, you also need to install these files from the
// resources/script-override/ folder: panel.js, places-menupopup.js, and
// translation-notification.js. After downloading them and placing them in your
// own resources/script-override/ folder, add the following lines to your
// utils/chrome.manifest file:
