...
// wait for customElements.js to load the scripts. waiting for autocomplete-richlistbox-popup because there's a stupid bug that doesn't let you call whenDefined on an element that doesn't have a dash in its name, unless the code is running in some specific namespace that I have no idea how to make my code run in.
(function () {
