...
class TabContextMenuNavigation {
    ...
    onPopupShowing(e) {
        ...
        if (this.contextTab.multiselected) {
            ...
            this.contextBack.disabled = !gBrowser.getBrowserForTab(this.contextTab).webNavigation
                .canGoBack;
            this.contextForward.disabled = !gBrowser.getBrowserForTab(this.contextTab).webNavigation
                .canGoForward;
    ...
    loadStylesheet() {
        if (matchMedia("(-moz-windows-non-native-menus)").matches)
            document.documentElement.setAttribute("non-native-menus", true);
