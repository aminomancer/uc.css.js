...
(function () {
    ...
    function start() {
        ...
        gTabsPanel.allTabsPanel.handleEvent = function (e) {
            ...
            switch (e.type) {
                ...
                case "ViewShowing":
                    ...
                    break;
                case "click":
                    this._multiSelectOrCloseTabs(e, tab);
                    break;
                case "command":
        ...
        gTabsPanel.allTabsPanel._multiSelectOrCloseTabs = function (e, tab) {
        ...
        gTabsPanel.allTabsPanel._onCommand = function (row, tab) {
        ...
        gTabsPanel.allTabsPanel._setTooltip = function (row, tab) {
