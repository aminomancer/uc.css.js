...
(function () {
    ...
    function registerSheet() {
        const css = `.all-tabs-item{border-radius:var(--arrowpanel-menuitem-border-radius);box-shadow:none;margin-inline:4px;min-height:28px;-moz-box-align:center;padding-inline-end:2px;overflow-x:-moz-hidden-unscrollable;}panelview .all-tabs-button:not([disabled],[open]):focus{background:none;}#allTabsMenu-allTabsViewTabs{margin:var(--panel-subview-body-padding);padding-block-start:0;}.all-tabs-item[selected],.all-tabs-item[multiselected],.all-tabs-item[usercontextid]:is(:hover,[_moz-menuactive]){background-image:linear-gradient(to right,var(--main-stripe-color) 0,var(--main-stripe-color) 4px,transparent 4px)!important;}.all-tabs-item[selected]{font-weight:normal;background-color:var(--arrowpanel-dimmed-further)!important;--main-stripe-color:var(--arrowpanel-dimmed-even-further);}.all-tabs-item[usercontextid]:not([multiselected]){--main-stripe-color:var(--identity-tab-color);}.all-tabs-item[multiselected]{--main-stripe-color:var(--multiselected-color,var(--lwt-selected-tab-background-color));}.all-tabs-item:not([selected]):is(:hover,:focus-within,[_moz-menuactive],[multiselected]){background-color:var(--arrowpanel-dimmed)!important;}.all-tabs-item[multiselected]:not([selected]):is(:hover,[_moz-menuactive]){background-color:var(--arrowpanel-dimmed-further)!important;}.all-tabs-item:not([selected]):is(:hover,[_moz-menuactive]):active{background-color:var(--arrowpanel-dimmed-further)!important;}.all-tabs-item[pending]:not([selected]):is(:hover,:focus-within,[_moz-menuactive],[multiselected]){background-color:var(--arrowpanel-faint,color-mix(in srgb,var(--arrowpanel-dimmed) 60%,transparent))!important;}.all-tabs-item[pending]>.all-tabs-button{opacity:.6;}.all-tabs-item .all-tabs-secondary-button,.all-tabs-item .all-tabs-secondary-button:focus:not([disabled]){max-width:18px;max-height:18px;border-radius:100%;color:white;background-color:transparent!important;opacity:.7;min-height:0;min-width:0;padding:0;}.all-tabs-secondary-button>.toolbarbutton-icon{min-width:18px;min-height:18px;fill:inherit;fill-opacity:inherit;-moz-context-properties:inherit;}.all-tabs-item .all-tabs-secondary-button>label:empty{display:none;}.all-tabs-item .all-tabs-secondary-button:is(:hover,:focus):not([disabled]),.all-tabs-item:is(:hover,:focus-within) .all-tabs-secondary-button[close-button]:is(:hover,:focus):not([disabled]){background-color:var(--arrowpanel-dimmed)!important;opacity:1;color:white;}.all-tabs-item .all-tabs-secondary-button:hover:active:not([disabled]),.all-tabs-item:is(:hover,:focus-within) .all-tabs-secondary-button[close-button]:hover:active:not([disabled]){background-color:var(--arrowpanel-dimmed-further)!important;}.all-tabs-item .all-tabs-secondary-button[toggle-mute]{padding:2px 2px 2px 1px;margin-inline-end:8px;}.all-tabs-secondary-button[close-button]{fill-opacity:0;transform:translateX(28px);opacity:0;margin-inline-start:-28px;transition:.075s ease-in-out transform,.075s ease-in-out margin,.075s linear opacity;display:block;-moz-context-properties:fill,fill-opacity,stroke;fill:currentColor;fill-opacity:0;border-radius:50%;list-style-image:url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='20' height='20'><rect fill='context-fill' fill-opacity='context-fill-opacity' width='20' height='20' rx='2' ry='2'/><path fill='context-fill' fill-opacity='context-stroke-opacity' d='M11.06 10l3.47-3.47a.75.75 0 00-1.06-1.06L10 8.94 6.53 5.47a.75.75 0 10-1.06 1.06L8.94 10l-3.47 3.47a.75.75 0 101.06 1.06L10 11.06l3.47 3.47a.75.75 0 001.06-1.06z'/></svg>");}.all-tabs-item:is(:hover,:focus-within) .all-tabs-secondary-button[close-button]{transform:none;opacity:.7;margin-inline-start:-2px;}`;
