(function () {
    function init () {
        ...
        const BMBinnerBox = document.getElementById('BMB_bookmarksToolbarPopup').shadowRoot.children[1];
        const BMBarrowScrollbox = document.getElementById('BMB_bookmarksToolbarPopup').shadowRoot.children[1].children[1];
        ...
        function toolbarPopupOpened() {
            try {
                const bmbSubviewButtons = document.getElementsByClassName('menu-iconic bookmark-item subviewbutton');
                BMBinnerBox.classList.add("BMB-special-innerbox");
                BMBarrowScrollbox.smoothScroll = true;
                BMBarrowScrollbox._scrollIncrement = 150;
                BMBarrowScrollbox._scrollButtonUp.classList.add("BMB-special-scrollbutton-up");
