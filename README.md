...
- Both of these delays can be changed with the `Configure Hover Delay` and `Configure Hover Out Delay` options in the context menu, or in about:config. For languages other than English, the labels and tooltips can be modified directly in the `l10n` object inside the script file.
