...
Download the [resources](/resources) folder and place it in your `chrome` folder — fx-autoconfig will automatically register it to the path `chrome://userchrome/content/`. Since this theme is updated on a daily basis to keep up with Nightly, I don't have any plans to publish release packages. You can clone the repo directly to your profile's `chrome` folder with [GitHub Desktop](https://desktop.github.com/), or you can download individual folders with [GitZip](https://addons.mozilla.org/en-US/firefox/addon/gitzip/) or [Refined GitHub](https://addons.mozilla.org/en-US/firefox/addon/refined-github-/).
...
6) &nbsp; a `resources` folder in your `chrome` folder, containing all the icons (assuming you're using the theme or one of the scripts that requires icon files);
