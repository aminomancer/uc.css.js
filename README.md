# **uc.css.js**
<p align="center">
<a href="/../../archive/HEAD.zip" title="Download the latest release package" aria-label="Download the latest release package"><img src=".readme/download.png" alt="Download" height="30"></a>
<a href="/../../subscription" title="Get update notifications" aria-label="Get update notifications"><img src=".readme/watch.png" alt="Watch" height="30"></a>
<a href="/../../issues/new/choose" title="Report a bug or request a new feature" aria-label="Report a bug or request a new feature"><img src=".readme/issue.png" alt="Issue" height="30"></a>
<a href="/../../discussions" title="Ask a question or discuss with other users" aria-label="Ask a question or discuss with other users"><img src=".readme/discuss.png" alt="Discuss" height="30"></a>
<a href="/../../fork" title="Make your own copy of this project" aria-label="Make your own copy of this project"><img src=".readme/fork.png" alt="Fork" height="30"></a>
<a href="https://github.com/aminomancer" title="Follow my work" aria-label="Follow my work"><img src=".readme/follow.png" alt="Follow" height="30"></a>
<a href="https://github.com/sponsors/aminomancer" title="Become a sponsor" aria-label="Become a sponsor"><img src=".readme/sponsor.png" alt="Sponsor" height="30"></a></br>
...
To modify the main window UI (as you'd do with userChrome.css) make a file in the `chrome` folder called `custom-chrome.css` and place your custom chrome styles in there. To modify content (as you'd do with userContent.css) make a file in [resources/in-content](/resources/in-content) called `custom-content.css` and place your custom content styles in there. The theme automatically looks for and imports these stylesheets, if they exist. They load after the theme's stylesheets, so they will override rules from the theme with equal specificity.
...
Optionally, you can also configure the script to use your other (non-default) search engines as well. The preference `userChrome.searchSelectionShortcut.match-engine-to-current-tab` will change the behavior so that, when you use the hotkey, it will look for an engine that matches the current webpage. So if your default search engine is Google but you use the hotkey on Wikipedia, and you have a search engine for Wikipedia installed, it will search Wikipedia for the selected text instead of Google. This preference is disabled by default. You can toggle it in a popup that appears the first time you install the script, or in about:config.

While this preference is enabled, a second hotkey will also be configured (Ctrl+Alt+F). This hotkey is just like the normal hotkey, but it will override the engine matching behavior, so it will use your default engine no matter what page you're on. In other words, if you're on Wikipedia but you want to search Google, you can use Ctrl+Alt+F instead. This override hotkey can be disabled by setting the preference `userChrome.searchSelectionShortcut.action-override-hotkey` to false. This hotkey only exists if both preferences are set to true.
